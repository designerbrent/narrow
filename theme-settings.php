 ...
 *   A form array.
 */
function narrow_settings($saved_settings) {

  // Get the default values from the .info file.
  $defaults = blueprint_theme_get_default_settings('narrow');
  ...
  $form['narrow_example'] = array(
    '#type'          => 'checkbox',
    '#title'         => t('Use this sample setting'),
    '#default_value' => $settings['narrow_example'],
